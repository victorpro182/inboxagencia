<footer class="site-footer">
  ...
  <div class="container">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-9 col-12 mb-4 pb-2">
                <h5 class="extrabold mb-3">Enlaces</h5>
                <ul class="site-footer-links">
                    <li class="site-footer-link-item">
                        <a href="<?php echo site_url(); ?>" class="medium">Inicio</a>
                    </li>
                    <li class="site-footer-link-item">
                        <a href="<?php echo site_url('Agencias/index'); ?>" class="medium">Agencia</a>
                    </li>
                    <li class="site-footer-link-item">
                        <a href="#" class="medium">Portafolio</a>
                    </li>
                    <li class="site-footer-link-item">
                        <a href="#" class="medium">Clientes</a>
                    </li>
                    <li class="site-footer-link-item">
                        <a href="#" class="medium">Contactanos</a>
                    </li>
                </ul>
            </div>
            <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0">
                <h5 class="extrabold mb-3">Buscanos</h5>
                <p class="medium d-flex mb-1">
                    <a href="https://goo.gl/maps/yy7FebzpnhcdsnkF9" class="medium" target="_blank">
                        Quito-Ecuador (Clic)
                    </a>
                </p>
                <p class="medium d-flex mb-1">
                    <a href="https://api.whatsapp.com/send?phone=5939905551281&text=Hola%20desde%20Quito!" class="medium" target="_blank">
                        0995551281 (WhatsApp)
                    </a>
                </p>
                <p class="medium d-flex">
                    <a href="mailto:hello@company.com?subject=Consulta%20desde%20Quito" class="medium">
                        hello@company.com (clic envianos un correo)
                    </a>
                </p>
            </div>
            <div class="col-lg-3 col-md-6 col-11 mb-4 mb-lg-0 mb-md-0">
                <h5 class="extrabold mb-3">Servicios</h5>
                <p class="medium d-flex mt-3 mb-2">
                    Diseño Gráfico - Diseño Web</p>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-9 col-12 mt-5">
                    <p class="copyright-text">InboxAgencia 2023 Agencia </p>
                </div>
